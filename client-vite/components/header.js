...
// }
const renderHeaderContent = (guestBlock, userBlock, isAuthPage, isMainNoAuth, isProfilePage)=> {
...
export async function renderHeader(selector = '#header', onSearchInput = ()=> null) {
  const container = document.querySelector(selector);
  if (!container) return;
